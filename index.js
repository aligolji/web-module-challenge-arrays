...
// const balls = ['basketball', 'soccer', 'football', 'volleyball', 'tennis'];
...
function removeFlavorByName(arr, string){
    ...
    for (i=0; i<31; i++){
        if (arr[i].includes('flavor to remove')){
...
console.log(removeFlavorByName(originalFlavors, 'flavor to remove'));
...
function copy(array, newarray){
    ...
    return twoScoopsOriginalFlavors;
}
